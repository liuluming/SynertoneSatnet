...
public interface LinphoneAccountCreator {
	...
	class UsernameCheck {
		...
		public static UsernameCheck fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				UsernameCheck state = values.elementAt(i);
	...
	class PhoneNumberCheck {
		...
		public static PhoneNumberCheck fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				PhoneNumberCheck state = values.elementAt(i);
				if (state.mValue == value) return state;
			}
			throw new RuntimeException("UsernameCheck not found [" + value + "]");
		}
	...
	class EmailCheck {
		...
		public static EmailCheck fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				EmailCheck state = values.elementAt(i);
				if (state.mValue == value) return state;
			}
	...
	class DomainCheck {
		...
		public static DomainCheck fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				DomainCheck state = values.elementAt(i);
				if (state.mValue == value) return state;
			}
	...
	class PasswordCheck {
		...
		public static PasswordCheck fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				PasswordCheck state = values.elementAt(i);
				if (state.mValue == value) return state;
			}
	...
	class LanguageCheck {
		...
		public static LanguageCheck fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				LanguageCheck state = values.elementAt(i);
				if (state.mValue == value) return state;
			}
	...
	class ActivationCodeCheck {
		...
		public static ActivationCodeCheck fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				ActivationCodeCheck state = values.elementAt(i);
				if (state.mValue == value) return state;
			}
	...
	class RequestStatus {
		...
		public static RequestStatus fromInt(int value) {
			for (int i=0; i < values.size(); i++) {
				RequestStatus state = values.elementAt(i);
				if (state.mValue == value) return state;
			}
