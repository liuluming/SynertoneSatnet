...
class LinphoneCoreImpl implements LinphoneCore {
	...
	LinphoneCoreImpl(LinphoneCoreListener listener, Object context) {
		mListener = listener;
	...
	public synchronized void addFriendList(LinphoneFriendList friendList) {
		addFriendList(nativePtr,((LinphoneFriendListImpl)friendList).nativePtr);
	}

	public synchronized void removeFriendList(LinphoneFriendList friendList) {
	...
	@Override
	public synchronized LinphoneProxyConfig createProxyConfig(String identity,String proxy,String route, boolean enableRegister) {
		isValid();
		try {
