...
private static AssistantActivity instance;
	...
	public String email;
	private long currentTime;//当前一次显示弹框的时间
	private long lastTime;//上一次显示弹框的时间
	...
	public Dialog createErrorDialog(LinphoneProxyConfig proxy, String message){
		...
		if(message.equals("Unauthorized")){
			message=getString(R.string.account_password_error);
		}
		if(message.equals("io error")){
			message=getString(R.string.domain_error);
		}
	...
	public void restartApplication() {
		...
		intent.setClassName(this, "synertone.com.satnet.startActivity");
		//Intent mStartActivity = new Intent(this, startActivity.class);
		PendingIntent mPendingIntent = PendingIntent.getActivity(this, (int) System.currentTimeMillis(), intent, PendingIntent.FLAG_CANCEL_CURRENT);
