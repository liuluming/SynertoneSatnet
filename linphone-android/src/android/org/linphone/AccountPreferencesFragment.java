...
public class AccountPreferencesFragment extends PreferencesListFragment implements LinphoneAccountCreator.LinphoneAccountCreatorListener {
	...
	private void hidePreferences() {
		...
		displayOptions = (PreferenceCategory) findPreference(getString(R.string.pref_sipaccount_key));
		displayOptions.removePreference(findPreference(getString(R.string.valid_user_name)));
		displayOptions.removePreference(findPreference(getString(R.string.key_show_name)));

	     displayOptions = (PreferenceCategory) findPreference(getString(R.string.pref_advanced_key));
	     getPreferenceScreen().removePreference(displayOptions);

	     displayOptions = (PreferenceCategory) findPreference(getString(R.string.pref_manage_key));
		displayOptions.removePreference(findPreference(getString(R.string.pref_disable_account)));
		displayOptions.removePreference(findPreference(getString(R.string.pref_default_account)));
		displayOptions.removePreference(findPreference(getString(R.string.pref_change_password)));
		...
		if (mPrefs.getAccountDomain(n).compareTo(getString(R.string.default_domain)) == 0) {
			...
			changePassword.setOnPreferenceClickListener(new OnPreferenceClickListener() {
				public boolean onPreferenceClick(Preference preference) {
					...
					final EditText pass1 = layout.findViewById(R.id.password1);
					final EditText pass2 = layout.findViewById(R.id.password2);
