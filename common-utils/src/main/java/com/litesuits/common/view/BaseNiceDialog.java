...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = (int) (ScreenUtil.getWidth(getContext()) - 2 * ScreenUtil.dp2px(getContext(), margin));
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = ScreenUtil.dp2px(getContext(), width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = ScreenUtil.dp2px(getContext(), height);
            }
