...
public final class UploadService extends Service {
     ...
     */
    public static String NAMESPACE ="com.synertone.ftpmoudle";
     ...
     */
    public static int BUFFER_SIZE = 1024*1204*10;
    ...
    private static final String ACTION_UPLOAD_SUFFIX = ".notification.action";
    ...
    private static final String BROADCAST_ACTION_SUFFIX = ".events.UploadReceiver";
    ...
    public static String getActionBroadcast() {
        return "com.synertone.ftpmoudle.events.UploadReceiver";
    }
